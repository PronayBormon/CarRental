                    ...
                    <a href="#" class="contact-list-link new">
                        <div class="d-flex">
                            <div class="pos-relative">
                                <img src="{{ asset('backend/img/img2.jpg') }}" class="wd-40 rounded-circle"
                                    alt="">
